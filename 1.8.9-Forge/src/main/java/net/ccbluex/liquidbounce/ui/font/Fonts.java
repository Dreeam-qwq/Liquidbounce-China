...
public class Fonts {
    ...
    public static void loadFonts() {
        ...
        ClientUtils.getLogger().info("加载字体中.");
        ...
        ClientUtils.getLogger().info("已加载字体. (" + (System.currentTimeMillis() - l) + "ms)");
    }
