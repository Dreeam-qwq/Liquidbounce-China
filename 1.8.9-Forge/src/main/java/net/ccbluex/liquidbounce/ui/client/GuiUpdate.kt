...
class GuiUpdate : GuiScreen() {
    ...
    override fun initGui() {
        ...
        buttonList.add(GuiButton(1, this.width / 2 + 2, j + 24 * 2, 98, 20, "确认"))
        buttonList.add(GuiButton(2, this.width / 2 - 100, j + 24 * 2, 98, 20, "下载"))
    }
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        drawCenteredString(Fonts.font35, "一个新的更新!", width / 2 / 2, height / 8 / 2 + 20, Color(255, 0, 0).rgb)
    }
